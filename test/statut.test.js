...
describe('statut', () => {
    ...
    it('execute statut cmd', async () => {
        const opt = new DiscordTest.options({"message": "statut", "type": "watching"})
    ...
    it('execute statut cmd too long', async () => {
        const opt = new DiscordTest.options({"message": "statutstatutstatutstatutstatutstatutstatutstatutstatutstatutstatutstatutstatutstatut", "type": "watching"})
        try {
            await statut.execute({
                interaction:DiscordTest.interaction,
                options:opt,
